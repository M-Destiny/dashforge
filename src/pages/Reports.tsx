        ...
        {metrics.map((m) => (
          ...
          >
            ...
            <div className="flex items-end justify-between mt-2">
              ...
              <span
                className={`text-sm font-medium ${m.trend === 'up' ? 'text-green-500' : 'text-red-500'}`}
              >
              ...
              {metrics.map((metric) => {
                ...
                return (
                  <tr key={metric.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center gap-1.5 font-medium ${metric.trend === 'up' ? 'text-green-500' : 'text-red-500'}`}
                      >
                        {metric.trendValue > 0 ? '+' : ''}
                        {metric.trendValue}%
                      </span>
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${metric.trend === 'up' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'}`}
                      >
